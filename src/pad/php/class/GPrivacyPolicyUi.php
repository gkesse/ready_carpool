...
class GPrivacyPolicyUi extends GObject {
    ...
    public function initAccess() {
        ...
        $lObj->addAccess("Politique de confidentialité", "/politiques/politique-de-confidentialite");
    }
    //===============================================
    public function run() {
        ...
        par <b>ReadyPad</b> et dont l'adresse enregistrée est <b>ReadyPad, Abidjan, Côte d'Ivoire</b>.
        ...
        <br><br>
        Toute demande d'accès au sujet doit être adressée par écrit à <b>ReadyPad, Abidjan, Côte d'Ivoire</b>.
