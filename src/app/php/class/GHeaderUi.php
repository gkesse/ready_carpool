...
class GHeaderUi extends GObject {
    ...
    public function run() {
        ...
        //
        echo sprintf("<a class='Header3' href='/services'>\n");
        ...
        echo sprintf("<a class='Header7' href='/services/trouver-un-trajet'><i class='fa fa-road'></i> Trouver un trajet</a>\n");
        echo sprintf("<a class='Header7' href='/services/proposer-un-trajet'><i class='fa fa-car'></i> Proposer un trajet</a>\n");
        echo sprintf("</div>\n");
        //
        ...
        //
        if(!$this->isLogin()) {
            echo sprintf("<a class='Header12' href='/services/connexion'>\n");
        ...
        //
        if(!$this->isLogin()) {
            echo sprintf("<a class='Header12' href='/services/inscription'>\n");
        ...
        //
        echo sprintf("<a class='Header12' href='/services/trouver-un-trajet'>\n");
        echo sprintf("<div class='Header13'>Trouver un trajet</div>\n");
        echo sprintf("<i class='Header14 fa fa-chevron-right'></i>\n");
        echo sprintf("</a>\n");
        //
        echo sprintf("<a class='Header12' href='/services/proposer-un-trajet'>\n");
        ...
        echo sprintf("</div>\n");
        // policy
        echo sprintf("<a class='Header12' href='/services/politiques'>\n");
