...
// styles
echo sprintf("<link rel='stylesheet' href='/app/css/styles.css'>\n");
//===============================================
echo sprintf("</head>\n");
echo sprintf("<body>\n");
//===============================================
...
//===============================================
echo sprintf("<script src='/app/js/scripts.js'></script>\n");
echo sprintf("<script src='/app/js/class/GObject.js'></script>\n");
echo sprintf("<script src='/app/js/class/GAjax.js'></script>\n");
echo sprintf("<script src='/app/js/class/GServer.js'></script>\n");
echo sprintf("<script src='/app/js/class/GTest.js'></script>\n");
echo sprintf("<script src='/app/js/class/GHeader.js'></script>\n");
echo sprintf("<script src='/app/js/class/GRegister.js'></script>\n");
echo sprintf("<script src='/app/js/class/GLogin.js'></script>\n");
echo sprintf("<script src='/app/js/class/GFacebook.js'></script>\n");
echo sprintf("<script src='/app/js/class/GRedirect.js'></script>\n");
//===============================================
// run
//===============================================
