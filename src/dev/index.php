<?php
//===============================================
require $_SERVER["DOCUMENT_ROOT"]."/dev/php/class/GInclude.php";
//===============================================
$lApp = new \dev\GApp();
$lProcess = new \dev\GProcess();
$lLogUi = new \com\GLogUi();
$lLoaderUi = new \com\GLoaderUi();
$lHeaderUi = new \dev\GHeaderUi();
$lAccessUi = new \dev\GAccessUi();
$lPageUi = new \dev\GPageUi();
//===============================================
...
// styles
echo sprintf("<link rel='stylesheet' href='/dev/css/styles.css'>\n");
//===============================================
echo sprintf("</head>\n");
echo sprintf("<body>\n");
//===============================================
...
//===============================================
echo sprintf("<script src='/dev/js/scripts.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GObject.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GAjax.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GServer.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GTest.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GHeader.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GRegister.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GLogin.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GFacebook.js'></script>\n");
echo sprintf("<script src='/dev/js/class/GRedirect.js'></script>\n");
//===============================================
// run
//===============================================
