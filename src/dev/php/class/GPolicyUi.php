...
class GPolicyUi extends GObject {
    ...
    public function initAccess() {
        ...
        $lObj->addAccess("Politiques", "/home/politiques");
    }
    //===============================================
    public function run() {
        ...
        echo sprintf("</div>\n");
        //
        echo sprintf("<a class='Policy5' href='/home/politiques/conditions-generales-utilisation'>\n");
        ...
        echo sprintf("</a>\n");
        //
        echo sprintf("<a class='Policy5' href='/home/politiques/politique-de-confidentialite'>\n");
        echo sprintf("<i class='Policy6 fa fa-file-text'></i>\n");
